...
var RulersGuides = function (evt, dragdrop) {
    'use strict';
    var rgContainer = document.createElement('div');
    rgContainer.id = RULERS_GUIDES_ID;
    ...
    var doc         = document.documentElement,
        ...
        Menu = function () {
            ...
            this.render = function () {
                ...
                evt.attach(TAP_EVT.PUSH, toggles.lock.obj, function () {
                    toggleRulersLock();
                });
            ...
            dragdrop.set(guide, {
                ...
                onstart: function (elem) {
                    ...
                    if (elem.over !== undefined) {
                        evt.detach(TAP_EVT.OVER, elem, elem.over);
                        evt.detach(TAP_EVT.OUT, elem, elem.out);
                    }
                },
                ...
                onstop: function (elem) {
                    elem.over = evt.attach(TAP_EVT.OVER, elem, function (e, src) {
                    ...
                    elem.out = evt.attach(TAP_EVT.OUT, elem, function () {
...
var  MaskHelper = (function (fixCls) {
    ...
    return {
        openMask() {
            var  root = html.scrollHeight > body.scrollHeight ? html : body;
